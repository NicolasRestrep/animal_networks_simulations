...
# save table 
net_fts_table %>% 
  gtsave("~/Documents/diffusion_animal_networks/Figures/network_feature_table.png", 
         expand = 10)
...
# save averages table 
avg_fts_table %>% 
  gtsave("~/Documents/diffusion_animal_networks/Figures/avg_feature_table.png", 
         expand = 10)
...
# Save the plot 
ggsave("~/Documents/diffusion_animal_networks/Figures/network_fts_plt.png", 
       height = 10, 
       width = 15, 
       dpi = 300)
...
# Save the plot 
ggsave("~/Documents/diffusion_animal_networks/Figures/eff_plt.png", 
       height = 10, 
       width = 15, 
       dpi = 300)
...
# Save the plot 
ggsave("~/Documents/diffusion_animal_networks/Figures/eleph_eff_plt.png", 
       height = 10, 
       width = 15, 
       dpi = 300)
...
baboon_diff <- srs_diff %>% 
  ...
  labs(title = "Baboons", 
       ...
       fill = "Removal Type") +
  theme(legend.position = "top") +
  scale_x_continuous(breaks = c(1, 50, 100),labels = c(1, 50, 100))
